...
from ..materials.spec import PASSED, material_specs, status_of, summary
...
class MainAgent:
    ...
    def _material_names(self, material_ids):
        ...
        catalog = self.scenario.get("materials") or {}
        return [catalog.get(mid, {}).get("name", mid) for mid in material_ids]
